...
queueMessage networkQueueMessage;
int networkTaskMessagesParams[MESSAGE_PARAMS_LENGTH];
...
void NetworkTask()
{
    ...
    CreateQueue(&networkQueue, &networkQueueMessage, 10, TAG);
    ...
    while(1)
    {
        ...
        if(xQueueReceive(networkQueue, &networkQueueMessage, 0))
        {
